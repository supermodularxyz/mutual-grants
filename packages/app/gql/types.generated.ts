...
export type MyRoundsQueryVariables = Exact<{
  address: Scalars['String'];
}>;


export type MyRoundsQueryResult = (
  { __typename?: 'Query' }
  & { roundAccounts: Array<(
    { __typename?: 'RoundAccount' }
    & Pick<RoundAccount, 'id'>
    & { round: (
      { __typename?: 'Round' }
      & Pick<Round, 'id'>
      & { program: (
...
export type MyProjectsQueryResult = (
  { __typename?: 'Query' }
  & { rounds: Array<(
    { __typename?: 'Round' }
    & Pick<Round, 'id'>
    & { projects?: Maybe<Array<(
      { __typename?: 'RoundProject' }
      & Pick<RoundProject, 'id' | 'status' | 'updatedAt'>
      & { metaPtr: (
        { __typename?: 'MetaPtr' }
        & Pick<MetaPtr, 'pointer'>
      ) }
      ...
      & { votes?: Maybe<Array<(
        { __typename?: 'QFVote' }
        & Pick<QfVote, 'amount' | 'projectId' | 'from' | 'token'>
      )>> }
    ) }
  )> }
);
...
export const MyRoundsDocument = /*#__PURE__*/ gql`
...
/**
 * __useMyRoundsQuery__
 *
 * To run a query within a React component, call `useMyRoundsQuery` and pass it any options that fit your needs.
 * When your component renders, `useMyRoundsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMyRoundsQuery({
 *   variables: {
 *      address: // value for 'address'
 *   },
 * });
 */
export function useMyRoundsQuery(baseOptions: Apollo.QueryHookOptions<MyRoundsQueryResult, MyRoundsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MyRoundsQueryResult, MyRoundsQueryVariables>(MyRoundsDocument, options);
      }
export function useMyRoundsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MyRoundsQueryResult, MyRoundsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MyRoundsQueryResult, MyRoundsQueryVariables>(MyRoundsDocument, options);
        }
export type MyRoundsQueryHookResult = ReturnType<typeof useMyRoundsQuery>;
export type MyRoundsLazyQueryHookResult = ReturnType<typeof useMyRoundsLazyQuery>;
export const MyProjectsDocument = /*#__PURE__*/ gql`
 ...
 * });
 */
export function useMyProjectsQuery(baseOptions: Apollo.QueryHookOptions<MyProjectsQueryResult, MyProjectsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MyProjectsQueryResult, MyProjectsQueryVariables>(MyProjectsDocument, options);
      }
export function useMyProjectsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MyProjectsQueryResult, MyProjectsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MyProjectsQueryResult, MyProjectsQueryVariables>(MyProjectsDocument, options);
        }
